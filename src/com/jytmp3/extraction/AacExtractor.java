 ...
 */
public class AacExtractor implements IAudioExtractor {
    @Override
    ...
    @Override
    public void writeChunk(byte[] bytes, long timeStamp) throws IOException {

    }

    private FileOutputStream videoStream; //Private fileStream As FileStream
